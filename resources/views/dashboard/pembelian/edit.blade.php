...
@section('container')
    ...
    <div class="col-lg-8">
        ...
        <form method="POST" action="/dashboard/pembelian/{{ $tbl_Hbeli->id }}" class="mb-5">
            @method('PUT')
            @csrf
            <div class="mb-3">
                ...
                <input type="text"
                    ...
                    is-invalid
                @enderror"
                    id="NOTRANSAKSI" name="NOTRANSAKSI" required autofocus
                    value="{{ old('NOTRANSAKSI', $tbl_Hbeli->NOTRANSAKSI) }}" readonly>
                @error('NOTRANSAKSI')
            ...
            @enderror"
                    ...
                    @foreach ($tbl_suplier as $tbl_suplier)
                        @if (old('KODESPL', $tbl_Hbeli->KODESPL) == $tbl_suplier->KODESPL)
                            <option value="{{ $tbl_suplier->KODESPL }}" selected>{{ $tbl_suplier->KODESPL }}</option>
                        @else
            ...
            <div class="mb-3">
                ...
                <input type="date"
                    ...
                    is-invalid
                @enderror"
                    id="TGLBELI" name="TGLBELI" required autofocus value="{{ old('TGLBELI', $tbl_Hbeli->TGLBELI) }}">
                @error('TGLBELI')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            @enderror"
                    ...
                    @foreach ($tbl_barang as $tbl_barang)
                        @if (old('KODEBRG', $tbl_Dbeli->KODEBRG) == $tbl_barang->KODEBRG)
                            <option value="{{ $tbl_barang->KODEBRG }}" selected>{{ $tbl_barang->KODEBRG }}
                ...
                <div class="mb-3">
                    ...
                    is-invalid
                @enderror"
                            id="HARGABELI" name="HARGABELI" required autofocus
                            value="{{ old('HARGABELI', $tbl_Dbeli->HARGABELI) }}" readonly>
                        @error('HARGABELI')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number"
                        ...
                        is-invalid
                    @enderror"
                        id="QTY" name="QTY" required autofocus value="{{ old('QTY', $tbl_Dbeli->QTY) }}"
                        onchange="getTotalrp()">
                    @error('QTY')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <input type="number"
                        ...
                        is-invalid
                    @enderror"
                        id="DISKON" name="DISKON" required autofocus value="{{ old('DISKON', $tbl_Dbeli->DISKON) }}"
                        onchange="diskonRP()">
                    @error('DISKON')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <span id="diskonRP">
                        ...
                        is-invalid
                    @enderror"
                            id="DISKONRP" name="DISKONRP" required autofocus
                            value="{{ old('DISKONRP', $tbl_Dbeli->DISKONRP) }}" readonly step="0.01">
                    </span>
                    @error('DISKONRP')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <span id="totalRp">
                        ...
                        is-invalid
                    @enderror"
                            id="TOTALRP" name="TOTALRP" required autofocus
                            value="{{ old('TOTALRP', $tbl_Dbeli->TOTALRP) }}">
                    </span>
                    @error('TOTALRP')
                        <div class="invalid-feedback">
                            {{ $message }}
